      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <ReactMarkdown
          components={{
            h1: ({ children }) => (
              <h1 
                className="text-3xl font-semibold mb-4 animate-card-entrance"
            ...
            h2: ({ children }) => (
              <h2 
                className="text-2xl font-semibold mt-8 mb-4 animate-card-entrance"
            ...
            h3: ({ children }) => (
              <h3 
                className="text-xl font-semibold mt-6 mb-3 animate-card-entrance"
            ...
            ul: ({ children }) => (
              <ul 
                className="list-disc pl-6 mb-4 animate-card-entrance"
            ...
            li: ({ children }) => (
              <li 
                className="mb-2 animate-card-entrance"
            ...
            p: ({ children }) => (
              <p 
                className="mb-4 animate-card-entrance"
